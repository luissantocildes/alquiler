// JavaScript Document
// variable que contrendrá los resultados
var documentoXML = '';
// variable que contendr� al objeto XMLHttpRequest
var ObjetoXMLHttpRequest = false;
// variable que indica si esta en depuraci�n
var depuracion;
depuracion = 0;
// URL del servidor en donde se llamaran las im�genes
var URLservidor;
...
// archivo XML que contiene las propiedades de las im�genes
...
listaArchivoXML['enviarMensaje'] = Array('POST', 'index2.php?opt=mensajes&task=enviarMensaje');

var funcion = '';
var idCapa = '';
var IE = false;

// Creaci�n del ObjetoXMLHttpRequest
try{
...
/***************************************
 * Mira si el parámetro es una cadena
 ***************************************/
...
/************************************
 * Recibe los resultados de la petición, los guarda y llama a la funcón adecuada
 ************************************/
 ...
 * Envía un mensaje
 *************************************/
function enviar_mensaje(nombreCapa) {
	...
	cargarXML('enviarMensaje', capaDatos, null, resultado_envio_mensaje);
}

/*************************************
 * comprueba el resultado del mensaje
 *************************************/
function resultado_envio_mensaje() {
...
function escribir_lista_usuarios () {
	...
	// Ahora muestra los datos del usuario, si se ha pasado
	if (datos.length) {
